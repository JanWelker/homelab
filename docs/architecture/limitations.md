...
certificates. See [Auto-unseal](../platform/openbao.md#auto-unseal).
...
pipeline as far as Alertmanager, not as far as the inbox. See
...
not at all against losing the cluster.
